...
class AdminPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->path('admin')
            ->login()
            ->brandName('Bengkel Rutin · Admin')
            ->font('Geist')
            ->favicon(asset('favicon.ico'))
            ->colors([
                'primary' => Color::hex('#A84F32'),
                'success' => Color::hex('#3E7453'),
                'warning' => Color::hex('#A56A19'),
                'danger' => Color::hex('#B8493F'),
                'gray' => Color::hex('#77746D'),
            ])
